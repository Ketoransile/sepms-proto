...
interface Submission {
    ...
    solution: { description: string; uniqueValue: string; competitiveAdvantage: string };
    businessModel: { revenueStreams: string; pricingStrategy: string; customerAcquisition: string };
    financials: { currentRevenue: string; projectedRevenue: string; burnRate: string; runway: string };
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                setError(data.errors?.join(", ") || data.message || "Submission failed");
            }
        } catch (err) {
            ...
            <div className="min-h-screen bg-background">
                ...
                <main className="mx-auto max-w-4xl px-4 py-8 space-y-6">
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <p className="text-muted-foreground leading-relaxed">{submission.summary || "Not provided"}</p>
                        </CardContent>
                    </Card>
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            <div>
                                ...
                                <p className="text-muted-foreground">{submission.problem?.statement || "Not provided"}</p>
                            </div>
                            <div>
                                <h4 className="font-medium mb-1">Target Market</h4>
                                <p className="text-muted-foreground">{submission.problem?.targetMarket || "Not provided"}</p>
                            </div>
                            <div>
                                <h4 className="font-medium mb-1">Market Size</h4>
                                <p className="text-muted-foreground">{submission.problem?.marketSize || "Not provided"}</p>
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            <div>
                                ...
                                <p className="text-muted-foreground">{submission.solution?.description || "Not provided"}</p>
                            </div>
                            <div>
                                <h4 className="font-medium mb-1">Unique Value Proposition</h4>
                                <p className="text-muted-foreground">{submission.solution?.uniqueValue || "Not provided"}</p>
                            </div>
                            <div>
                                <h4 className="font-medium mb-1">Competitive Advantage</h4>
                                <p className="text-muted-foreground">{submission.solution?.competitiveAdvantage || "Not provided"}</p>
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            <div>
                                ...
                                <p className="text-muted-foreground">{submission.businessModel?.revenueStreams || "Not provided"}</p>
                            </div>
                            <div>
                                <h4 className="font-medium mb-1">Pricing Strategy</h4>
                                <p className="text-muted-foreground">{submission.businessModel?.pricingStrategy || "Not provided"}</p>
                            </div>
                            <div>
                                <h4 className="font-medium mb-1">Customer Acquisition</h4>
                                <p className="text-muted-foreground">{submission.businessModel?.customerAcquisition || "Not provided"}</p>
                            </div>
                        </CardContent>
                    </Card>
                        ...
                        <CardContent>
                            <div className="grid gap-4 sm:grid-cols-2">
                                <div className="rounded-lg bg-muted/50 p-4">
                                    ...
                                    <p className="font-semibold">{submission.financials?.currentRevenue || "Not provided"}</p>
                                </div>
                                <div className="rounded-lg bg-muted/50 p-4">
                                    <p className="text-sm text-muted-foreground">Projected Revenue</p>
                                    <p className="font-semibold">{submission.financials?.projectedRevenue || "Not provided"}</p>
                                </div>
                                <div className="rounded-lg bg-muted/50 p-4">
                                    <p className="text-sm text-muted-foreground">Monthly Burn Rate</p>
                                    <p className="font-semibold">{submission.financials?.burnRate || "Not provided"}</p>
                                </div>
                                <div className="rounded-lg bg-muted/50 p-4">
                                    <p className="text-sm text-muted-foreground">Remaining Runway</p>
                                    <p className="font-semibold">{submission.financials?.runway || "Not provided"}</p>
                                </div>
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    <div className="flex items-center justify-between rounded-xl border bg-card p-6">
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                                Your pitch will be analyzed by our AI system for scoring and matching.
                            </p>
                        </div>
