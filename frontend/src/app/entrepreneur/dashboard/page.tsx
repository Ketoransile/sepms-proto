            ...
            <DashboardLayout navItems={ENTREPRENEUR_NAV} title="SEPMS">
                ...
                {justSubmitted && (
                    <div className="mb-6 rounded-lg border border-green-500/20 bg-green-500/10 p-4 text-sm">
                        🎉 Your pitch was submitted successfully! Our AI will analyze it shortly.
                    </div>
                )}
                ...
                <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <p className="mt-1 text-muted-foreground">Manage your pitches and track investor interest</p>
                    </div>
                ...
                <div className="grid gap-4 sm:grid-cols-3 mb-8">
                    <Card>
                        <CardContent className="p-5">
                            ...
                            <p className="text-xs text-muted-foreground mt-0.5">{drafts.length} draft{drafts.length !== 1 ? "s" : ""}</p>
                        </CardContent>
                    </Card>
                    <Card>
                        <CardContent className="p-5">
                    ...
                    <Card>
                        <CardContent className="p-5">
                            ...
                            <p className="text-xs text-muted-foreground mt-0.5">Active investor matches</p>
                        </CardContent>
                    </Card>
                </div>
                ...
                {loading ? (
                    ...
                    <Card className="border-dashed">
                        <CardContent className="flex flex-col items-center justify-center py-16">
                            ...
                            <h3 className="text-lg font-semibold mb-2">Submit Your First Pitch</h3>
