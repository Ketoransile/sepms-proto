...
export default function VerifyEmailPage() {
    const { user, userProfile, loading, resendVerificationEmail, refreshUserProfile, signOut } = useAuth();
    ...
    useEffect(() => {
        if (!loading && userProfile?.emailVerified) {
            ...
            router.push(redirects[userProfile.role || "entrepreneur"] || "/entrepreneur/dashboard");
        }
                ...
                <div className="mx-auto w-full max-w-md space-y-8">
                    ...
                    <div className="rounded-xl border border-border/50 bg-muted/20 p-6 space-y-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <p className="font-medium text-sm">Verification email sent to</p>
                    ...
                    <div className="rounded-xl border border-amber-500/30 bg-amber-500/5 p-4 flex items-start gap-3">
                        ...
                        <div>
                            <p className="text-sm font-medium text-amber-600 dark:text-amber-400">Check your spam/junk folder</p>
                            <p className="text-xs text-muted-foreground mt-1">
                                The verification email may land in your spam or junk folder. If you find it there, mark it as &quot;Not Spam&quot; and click the verification link.
                            </p>
                        </div>
                    </div>
                        ...
                        <Button
                            onClick={async () => {
                                ...
                                if (!userProfile?.emailVerified) {
                                    toast.info("Email not verified yet. Please check your inbox and spam folder.");
                                }
                            }}
                            variant="default"
                            className="w-full h-11 font-medium"
