            ...
            <div>
              ...
              <ul className="space-y-2.5">
                {["AI Scoring", "Semantic Matching", "Document Verification", "Audio Summaries", "Analytics Dashboard"].map((item) => (
                  <li key={item}>
                    <Link href="#features" className="text-sm text-muted-foreground hover:text-foreground transition-colors">{item}</Link>
                  </li>
                ))}
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2.5">
                {["How it Works", "FAQ", "API Documentation", "System Architecture", "Privacy Policy"].map((item) => (
                  <li key={item}>
                    <Link href="#faq" className="text-sm text-muted-foreground hover:text-foreground transition-colors">{item}</Link>
                  </li>
                ))}
              </ul>
            </div>
