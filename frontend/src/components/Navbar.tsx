...
export default function Navbar() {
    ...
    return (
        <div className="fixed top-0 left-0 right-0 z-50 flex justify-center md:px-4 md:pt-4">
            <header
                className={`w-full border-b border-white/20 dark:border-white/10 bg-background/30 dark:bg-background/20 backdrop-blur-2xl backdrop-saturate-[1.8] transition-all duration-300 md:max-w-4xl md:rounded-2xl md:border md:border-white/20 md:dark:border-white/10 md:shadow-sm md:shadow-black/5 ${navVisible
